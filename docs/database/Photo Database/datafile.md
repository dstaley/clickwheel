...
28 | next id for mhii | 4 | The id of last mhii + 1. (is probably used as the id of a newly added mhii and then incremented). On iPod (5th generation) this seems to be the id of the last mhii + the total number of photo albums (mhba) + 1.
32 | unknown5 | 8 | 
40 | unknown6 | 8 | 
